...
public class RegistrationController {
   private RegistrationService registrationService;
    ...
    public ResponseEntity <List<RegistrationDto>> getAllRegistration(){
        ...
        return new ResponseEntity<>(dtos, HttpStatus.OK);//200
  ...
  @PostMapping
    ...
    RegistrationDto regDto = registrationService.createRegistration(registrationDto);
     return new ResponseEntity<>(regDto,HttpStatus.CREATED);//201
}
@DeleteMapping
...
@PutMapping ("/{id}")
    ...
    Registration registration2 = registrationService.updateRegistration(id, registration);
    return new ResponseEntity<>(registration2,HttpStatus.OK);//200
}

@GetMapping("/{regid}")
public ResponseEntity<RegistrationDto> getRegistrationById(@PathVariable("regid") long id){
